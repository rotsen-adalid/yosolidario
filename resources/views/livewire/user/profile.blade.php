            ...
            @if($this->user->profile)
                ...
                <div class="mt-3 space-y-2 flex">
                    <div class="flex space-x-3">
                        ...
                        @endif
                        @if($this->user->profile->country and $this->user->profile->whatsapp)
                        <a href="https://api.whatsapp.com/send?phone={{$this->user->profile->country->telephone_prefix}}{{$this->user->profile->whatsapp}}" target="_blank">
                ...
                <div class="mt-2">
                    <x-secondary-button class="text-sm" wire:click="editProfile" wire:loading.attr="disabled">
                        {{ __('Edit profile') }}
                    </x-secondary-button>
                </div>
                @endauth
