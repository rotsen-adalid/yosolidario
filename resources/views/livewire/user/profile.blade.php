    ...
    <div class="max-w-md w-full space-y-8">
      <div> 
        @if($this->user->profile_photo_path)
            <img class="mx-auto w-40 h-40 sm:w-56 sm:h-56  rounded-full object-cover object-center" src="{{ URL::to('/') }}{{ $this->user->profile_photo_path }}" alt="Workflow">
        @else 
        <img class="sm:w-56 sm:h-56 mx-auto rounded-full" src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}" />
        @endif
        ...
        <p class="mt-0 text-center text-base text-gray-600">
                ...
                <a href="https://www.facebook.com/{{$this->user->profile[0]->facebook}}" target="_blank">
                    <svg class="h-6 sm:h-8" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        ...
                        <path style="fill:#FFFFFF;" d="M70.201,58.294h-10.01v36.672H45.025V58.294h-7.213V45.406h7.213v-8.34
                            c0-5.964,2.833-15.303,15.301-15.303L71.56,21.81v12.51h-6 sm:h-8.151c-1.337,0-3.217,0.668-3.217,3.513v7.585h11.334L70.201,58.294z"/>
