<nav x-data="{ open: false, open0:false }" class="abosolute bg-white border-b border-gray-100  header w-full  fixed top-0">
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-4 lg:px-4">
      <div class="flex justify-between h-20">
          ...
          <div class="hidden lg:flex">
                ...
                @else 
                    <div class="ml-3 mt-1 flex items-center hidden">
                        <span class="material-icons-outlined text-3xl">notifications</span>
                    </div>
                @endif
              <!-- Settings Dropdown -->
