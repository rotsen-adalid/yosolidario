<div>
    <nav x-data="{ open: false }" class=" bg-white border-b border-gray-100 fixed top-0 header w-full ">
          ...
          <div class="flex justify-between h-20">
              ...
              <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="relative text-gray-600 ">
                  ...
                  <div class="ml-3">
                    <button wire:click="donate({{$this->organization->id}})" type="button" type="button" 
                        class="shadow-md border bg-yellow-400 border-yellow-500 text-black py-1 px-2 font-bold rounded-md text-base
              ...
              <div class="-mr-2 flex items-center sm:hidden">
                    ...
                    <button wire:click="$emit('sharedOpen', {{$this->organization->id}})" wire:loading.attr="disabled" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
      ...
      <div :class="{'block': open, 'hidden': ! open}" x-on:click.away="open = false" class="hidden sm:hidden">
            ...
            <div class="px-4 pt-3">
                <button wire:click="$emit('sharedOpen', {{$this->organization->id}})" wire:loading.attr="disabled" type="button" 
            ...
            <div class="px-4 py-4 ">
                <button wire:click="donate({{$this->organization->id}})" type="button" 
