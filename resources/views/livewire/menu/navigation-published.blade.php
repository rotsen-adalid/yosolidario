      ...
      <div class="flex justify-between h-20">
          ...
          <div class="hidden sm:flex sm:items-center sm:ml-6">
            ...
            -->
              ...
              <div class="ml-3">
                <button wire:click="$emit('sharedOpen', {{$this->campaign->id}})" wire:loading.attr="disabled" type="button" 
                    class=" border border-yellow-500 text-black py-1 px-2 font-bold rounded text-base
                    hover:bg-white focus:outline-none focus:border-yellow-500 shadow-sm focus:shadow-outline-yellow active:bg-yelow-400 transition ease-in-out duration-150">
                        {{__('Share')}}
                </button>
              </div>
              <div class="ml-3">
                @if ($this->campaign->categoryCampaign->type == 'SOCIAL_IMPACT')
                    <button wire:click="$emit('backThisCampaign', {{$campaign->id}})" wire:loading.attr="disabled" type="button" 
                        class="shadow-md border bg-yellow-400 border-yellow-500 text-black py-1 px-4 font-bold rounded text-base
                ...
                @elseif ($this->campaign->categoryCampaign->type == 'PROJECT')
                    <button type="button" 
                        class="shadow-md border bg-yellow-400 border-yellow-500 text-black py-1 px-2 font-bold rounded text-base
                        hover:bg-yellow-400 focus:outline-none focus:border-yellow-500 shadow-sm focus:shadow-outline-yellow active:bg-yelow-400 transition ease-in-out duration-150">
              ...
              <div class="hidden space-x-3 sm:-my-px sm:ml-5 sm:flex items-center">
                  ...
                  <button wire:click="$emit('sharedOpen', {{$this->campaign->id}})" wire:loading.attr="disabled" type="button" 
                    class="shadow-md border border-yellow-500 text-black py-1 px-2 font-bold rounded-md text-base
          ...
          <div class="-mr-2 flex items-center sm:hidden">
                ...
                <button wire:click="$emit('sharedOpen', {{$this->campaign->id}})" wire:loading.attr="disabled" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
