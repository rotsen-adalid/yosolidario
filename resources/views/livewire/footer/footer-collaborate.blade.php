...
<footer class="footer bg-white relative pt-1 border-t border-gray-100 h-full">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        <div class="sm:flex sm:mt-5">
            <div class="mt-8 sm:mt-0 sm:w-full flex flex-col md:flex-row justify-between items-center space-y-3 pb-7">
                <div class="flex ">
                ...
                <div class="flex flex-row space-x-5">
                    <span><a href="{{ route('set_language', 'es') }}" class="text-gray-700  text-md hover:text-gray-900">Español</a></span>
                    <span><a href="{{ route('set_language', 'en') }}" class="text-gray-700  text-md hover:text-gray-900">English</a></span>
                    <span><a href="{{ route('set_language', 'pt_BR') }}" class="text-gray-700  text-md hover:text-gray-900">Português</a></span>
                </div>
