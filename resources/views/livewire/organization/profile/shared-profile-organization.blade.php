    ...
    <x-slot name="content">
        ...
        <div x-show="rrss">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-10">
                <div>
                    <a  href="javascript:windowFacebook('{{$organization->name}}', '{{$organization->slug}}')">
                ...
                <div>
                    <a  href="javascript:windowMessenger('{{$organization->name}}', '{{$organization->slug}}')">
                        <div class="flex justify-center">
                ...
                <div>
                    <a  href="javascript:windowTwitter('{{$organization->name}}', '{{$organization->slug}}')">
                        <div class="flex justify-center">
                ...
                <div>
                    <a  href="javascript:windowWhatsApp('{{$organization->name}}', '{{$organization->slug}}')">
                        <div class="flex justify-center">
                ...
                <div>
                    <a  href="javascript:windowTelegram('{{$organization->name}}', '{{$organization->slug}}')">
                        <div class="flex justify-center">
                ...
                <div>
                    <a  href="mailto:?subject={{$organization->name}}  :  yosolidario.com&amp;body=https://www.yosolidario.com/{{$organization->slug}}" class="keyboard-focusable">
                        <div class=" flex justify-center">
            ...
            <p id="p1" class="border p-2">https://yosolidario.com/org/{{$organization->slug}}</p>
        ...
        <div x-show="embed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-3">
                ...
                <div class="">
                    ...
                    @if($widget == 'large')
                        <iframe src="{{ $host}}/org/{{$organization->slug}}/widget/large/?iframe=true" height="350"></iframe>
                    @elseif($widget == 'medium')
                        <iframe src="{{ $host}}/org/{{$organization->slug}}/widget/medium/?iframe=true" height="145"></iframe>
                    @elseif($widget == 'small')
                        <iframe src="{{ $host}}/org/{{$organization->slug}}/widget/small/?iframe=true" height="60"></iframe>
                    @endif
                </div>
        ...
        <script> 
            ...
            function windowTwitter (name, slug){ 
                var myURL = "https://twitter.com/intent/tweet?text="+name+" https://www.yosolidario.com/org/"+slug+"";
                windowOpen(myURL, name);
            }
            function windowFacebook(name, slug){ 
                FB.ui({
                    method: 'share',
                    href: "https://www.yosolidario.com/org/"+slug,
                    }, function(response){});
                //var myURL = "https://www.facebook.com/sharer/sharer.php?u=https://www.yosolidario.com/"+slug+"&src=sdkpreparse";
                windowOpen(myURL, name);
            } 
            function windowWhatsApp(name, slug){ 
                var myURL = "https://wa.me/?text=https://www.yosolidario.com/org/"+slug+"";
                windowOpen(myURL, name);
            }
            function windowTelegram(name, slug){ 
                var myURL = "https://t.me/share/url?url=https://www.yosolidario.com/org/"+slug+"&text="+name+"";
                windowOpen(myURL, name);
            }
            function windowMessenger(name, slug){ 
                FB.ui({
                    method: 'send',
                    link: "https://www.yosolidario.com/org/"+slug,
                    });
            ...
            function windowOpen(myURL, name) {
                var myWindow = window.open(myURL, name, 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=' + myWidth + ', height=' + myHeight + ', top=' + top + ', left=' + left);
            } 
