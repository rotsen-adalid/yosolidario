    ...
    <div class="border rounded-lg" style="width: 280px;">
        ...
        <div class=" w-full bg-white mt-2  rounded-lg overflow-hidden p-2">
            ...
            <div class="flex mt-4 space-x-2 justify-beetwen items-center">
                <a href="https://www.yosolidario.com/{{$this->campaign->slug}}" target="_blank" class="flex justify-beetwen w-full px-4 py-2 sm:py-3 text-center bg-yellow-400 border border-yellow-500 rounded-md font-bold text-sm text-black uppercase tracking-widest hover:bg-yellow-500 active:bg-yellow-500 focus:outline-none focus:border-gray-100 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">
