<div 
  ...
  <template x-for="slide in slides" :key="slide">
    <div
      ...
      class="p-24 font-bold text-5xl h-56 sm:h-96 flex justify-center items-center bg-red-500 text-white">
  ...
  <div class="absolute inset-0 flex">
    <div class="flex items-center justify-start w-1/2">
      <button 
        class="bg-red-100 text-red-500 hover:text-red-500 font-bold hover:shadow-lg focus:outline-none rounded-full w-12 h-12 ml-1"
    ...
    <div class="flex items-center justify-end w-1/2">
      <button 
        class="bg-red-100 text-red-500 hover:text-red-500 font-bold hover:shadow-lg focus:outline-none rounded-full w-12 h-12 mr-1"
  ...
  <!-- Buttons -->
  <div class="hidden absolute w-full flex items-center justify-center px-4">
    <template x-for="slide in slides" :key="slide">
      <button
        ...
        :class="{ 
            'bg-yellow-400': activeSlide === slide,
