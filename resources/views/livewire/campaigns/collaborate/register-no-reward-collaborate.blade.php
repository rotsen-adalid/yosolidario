                        ...
                        <div class="flex flex-col sm:flex-row space-x-2 items-center">
                            ...
                            <div>
                                <div>
                                    ...
                                    <span class="font-bold">{{$this->cutLetter($campaign->title, 25)}}</span>
                                </div>
                                <div>
                            ...
                            <div class="flex sm:flex-col flex-col space-y-2 sm:space-y-2 justify-center">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="">+1000 {{__('Payment points, Banks, Pharmacies, Commercial premises, etc')}}</div>
                                    </div>
                                </div>
                    ...
                    <div class="border-b border-gray-200 py-5">
                        <div class="flex justify-between text-gray-600 text-base">
                            ...
                            @if ($this->amount_collaborator)
                                <span>{{ number_format($this->amount_collaborator, 2 ) }}
                                    {{$this->currency}}
                                </span>
                            @else
                                <span>0.00
