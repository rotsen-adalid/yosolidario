<div class="bg-white shadow mb-10 w-full"> 
    ...
    <div class="flex flex-row justify-between sm:items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-2 sm:space-y-0">
            ...
            <div class="flex space-x-4 items-center">
                ...
                <div>
                    ...
                    <div class="h-1 relative  rounded-full  mt-2">
                        ...
                        <div class="h-full bg-green-500" style="width:{{$campaign->campaignCollected->amount_percentage_collected}}%"></div>
                    </div>
                    <!-- -->
