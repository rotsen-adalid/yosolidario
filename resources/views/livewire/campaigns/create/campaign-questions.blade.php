    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-2 py-0 sm:py-10">
        <div class="border border-gray-100 my-5 py-10 px-4 sm:px-20 rounded shadow bg-white">
                ...
                <div class="mt-2" x-show="photoPreview">
                    @if($this->photoTwo)
                        <span class="block rounded-sm h-48 sm:h-72 w-full"
                            x-bind:style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + photoPreview + '\');'">
                            <x-icon-button wire:click="deleteTwo" class=" flex justify-center m-1 opacity-70">
                                <span class="material-icons-outlined">delete</span>
                            </x-icon-button>
                        </span>
                    @else 
            ...
            <div x-data="{photoName: null, photoPreview: null}" class="mt-6">
                ...
                <div class="mt-2" x-show="photoPreview">
                    @if($this->photoThree)
                        <span class="block rounded-sm w-full h-48 sm:h-72"
                            x-bind:style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + photoPreview + '\');'">
                            <x-icon-button wire:click="deleteThree" class=" flex justify-center m-1 opacity-70">
                                <span class="material-icons-outlined">delete</span>
                            </x-icon-button>
                        </span>
                    @else 
            ...
            <div x-data="{photoName: null, photoPreview: null}" class="mt-6">
                ...
                <div class="mt-2" x-show="photoPreview">
                    @if($this->photoFour)
                        <span class="block rounded-sm w-full h-48 sm:h-726"
                            x-bind:style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + photoPreview + '\');'">
                            <x-icon-button wire:click="deleteFour" class=" flex justify-center m-1 opacity-70">
                                <span class="material-icons-outlined">delete</span>
                            </x-icon-button>
                        </span>
                    @else 
            ...
            <div x-data="{photoName: null, photoPreview: null}" class="mt-6">
                ...
                <div class="mt-2" x-show="photoPreview">
                    @if($this->photoFive)
                        <span class="block rounded-sm w-full h-48 sm:h-72"
                            x-bind:style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + photoPreview + '\');'">
                            <x-icon-button wire:click="deleteFive" class=" flex justify-center m-1 opacity-70">
                                <span class="material-icons-outlined">delete</span>
                            </x-icon-button>
                        </span>
                    @else 
            ...
            <div x-data="{photoName: null, photoPreview: null}" class="mt-6">
                ...
                <div class="mt-2" x-show="photoPreview">
                    @if($this->photoSix)
                        <span class="block rounded-sm w-full h-48 sm:h-72"
                            x-bind:style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + photoPreview + '\');'">
                            <x-icon-button wire:click="deleteSix" class=" flex justify-center m-1 opacity-70">
                                <span class="material-icons-outlined">delete</span>
                            </x-icon-button>
                        </span>
                    @else 
