    ...
    <x-slot  name="content">
        ...
        <x-input-section class="mt-10 sm:mt-0">
            ...
            <x-slot name="form">
                <!-- use_of_money -->
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="use_of_money" value="{{ __('What is it about?') }}" />
                ...
                <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                    ...
                    <div class="mt-2" x-show="!photoPreview">
                        ...
                        @else 
                            <img src="{{asset('images/photo_upload.png')}}" alt="" class="rounded-sm h-60 sm:h-72w-full object-cover">
                        @endif
                    </div>
        ...
        <x-input-section class="mt-10 sm:mt-0">
            ...
            <x-slot name="form">
                <!-- about_organizer -->
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="about_organizer" value="{{ __('What is it about?') }}" />
        ...
        <x-input-section class="mt-10 sm:mt-0">
            <x-slot name="title">
                {{ __('How and when will the recognitions be delivered?') }}
            </x-slot>
        
            <x-slot name="description">
                <div class="sm:pt-3">
                    {{ __('The recognitions that you will offer to your community to acknowledge their donations can be material or digital. We suggest you mention if the delivery, in case these are material, will have any shipping cost.') }}
                </div>
            </x-slot>
            <x-slot name="form">
               <!-- delivery_of_awards -->
               <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="delivery_of_awards" value="{{ __('What is it about?') }}" />
                    <x-textarea id="delivery_of_awards" class="mt-1 block w-full h-36 sm:h-36" wire:model.defer="delivery_of_awards" autocomplete="off"/>
                    <x-jet-input-error for="delivery_of_awards" class="mt-2" />
                </div>
                <!-- Photo -->
                <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                    <!-- Profile Photo File Input -->
                    ...
                    <!-- Current Profile Photo -->
                    <div class="mt-2" x-show="!photoPreview">
                        @if( $this->delivery_of_awards_url)
                        <x-icon-button wire:click="deleteFour" class="absolute m-1 opacity-70">
                            <i class="uil uil-trash text-base"></i>
                        </x-icon-button>
                            <img src="{{ URL::to('/') }}{{$this->delivery_of_awards_url}}" alt="" class="rounded-sm h-60 sm:h-72 w-full object-cover">
                        @else 
                            <img src="{{asset('images/photo_upload.png')}}" alt="" class="rounded-sm h-60 sm:h-72 w-full object-cover">
                        @endif
                    </div>
        ...
        <x-input-section class="mt-10 sm:mt-0">
            ...
            <x-slot name="form">
                <!-- contact_organizer -->
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="contact_organizer" value="{{ __('What is it about?') }}" />
