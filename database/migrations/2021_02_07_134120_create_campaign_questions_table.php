...
class CreateCampaignQuestionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('campaign_questions', function (Blueprint $table) {
            ...
            $table->longText('delivery_of_rewards')->nullable();
            $table->longText('delivery_of_rewards_es')->nullable();
            $table->longText('delivery_of_rewards_en')->nullable();
            $table->longText('delivery_of_rewards_pt_BR')->nullable();
            $table->string('delivery_of_rewards_url')->nullable();
