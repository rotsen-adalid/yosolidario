...
class RegisterNoRewardOrganizationCollaborate extends Component
{
    ...
    {
        return view('livewire.organization.collaborate.register-no-reward-organization-collaborate');
    }
